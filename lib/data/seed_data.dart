...
final List<Product> products = [
  Product(id: 1, category: 'shampoo', name: '미쟝센 퍼펙트 세럼 샴푸', brand: '미쟝센', price: '9,900원',
    ...
    tags: ['수분', '손상케어', '실리콘프리'],
    imageUrl: 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?w=400&q=80'),
  ...
  Product(id: 5, category: 'treatment', name: '모로칸오일 인텐스 하이드레이팅 마스크', brand: '모로칸오일', price: '48,000원',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1621607512022-6aecc4fed814?w=400&q=80'),
  ...
  Product(id: 9, category: 'curlcream', name: 'LG 리엔 엘라스틴 컬리 크림', brand: 'LG', price: '11,000원',
    ...
    tags: ['가벼운', '웨이비', '자연스러운'],
    imageUrl: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=400&q=80'),
  ...
  Product(id: 11, category: 'curlcream', name: '뷰나 컬링 젤리 크림', brand: '뷰나', price: '15,500원',
    ...
    tags: ['젤리타입', '수분', '컬정의'],
    imageUrl: 'https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?w=400&q=80'),
];
...
List<CommunityPost> communityPosts = [
  CommunityPost(id: 1, author: '꼬불이', avatar: '🌸', curlType: '3B', time: '2시간 전',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1559599101-f09722fb4948?w=600&q=80'),
  ...
  CommunityPost(id: 3, author: '컬리걸서울', avatar: '🍥', curlType: '3C', time: '어제',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1523264653568-d3d4032d1476?w=600&q=80'),
...
List<DiaryEntry> diaryEntries = [
  DiaryEntry(id: 1, date: DateTime(2024, 3, 1),
    ...
    imageUrl: 'https://images.unsplash.com/photo-1617130394164-b49a10e0d0f1?w=400&q=80'),
