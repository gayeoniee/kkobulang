...
final List<Product> products = [
  Product(id: 1, category: 'shampoo', name: '미쟝센 퍼펙트 세럼 샴푸', brand: '미쟝센', price: '9,900원',
    ...
    tags: ['수분', '손상케어', '실리콘프리'],
    imageUrl: 'assets/p_shampoo_mjansen.png'),
  Product(id: 2, category: 'shampoo', name: '리엔 퍼퓸 헤어케어 샴푸', brand: '리엔', price: '12,500원',
    ...
    tags: ['향기', '컬정의', '두피케어'],
    imageUrl: 'assets/p_shampoo_lien.jpg'),
  Product(id: 3, category: 'shampoo', name: 'CGM 저자극 클렌징 샴푸', brand: '꼬불랑랩', price: '18,000원',
    ...
    tags: ['CGM', '설페이트프리', '저자극'],
    imageUrl: 'assets/p_shampoo_cgm.jpg'),
  Product(id: 4, category: 'shampoo', name: '댕기머리 탈모증상 완화 샴푸', brand: '댕기머리', price: '14,900원',
    ...
    tags: ['두피케어', '볼륨', '한방'],
    imageUrl: 'assets/p_shampoo_daenggi.jpg'),
  Product(id: 5, category: 'treatment', name: '모로칸오일 인텐스 하이드레이팅 마스크', brand: '모로칸오일', price: '48,000원',
    ...
    imageUrl: 'assets/p_treatment_moroccan.jpg'),
  Product(id: 6, category: 'treatment', name: '케라시스 딥케어 트리트먼트', brand: '케라시스', price: '8,900원',
    ...
    tags: ['케라틴', '컬정의', '가성비'],
    imageUrl: 'assets/p_treatment_kerasys.jpg'),
  Product(id: 7, category: 'treatment', name: '이니스프리 마이 헤어레시피 딥케어팩', brand: '이니스프리', price: '16,000원',
    ...
    imageUrl: 'assets/p_treatment_innisfree.jpg'),
  Product(id: 8, category: 'curlcream', name: '캐니스 컬 디파이닝 크림', brand: '캐니스', price: '22,000원',
    ...
    tags: ['컬유지', '안티프리즈', '국산'],
    imageUrl: 'assets/p_cream_canis.jpg'),
  Product(id: 9, category: 'curlcream', name: 'LG 리엔 엘라스틴 컬리 크림', brand: 'LG', price: '11,000원',
    ...
    tags: ['가벼운', '웨이비', '자연스러운'],
    imageUrl: 'assets/p_cream_elastine.jpg'),
  Product(id: 10, category: 'curlcream', name: '데브아컬 슈퍼 크림', brand: 'DevaCurl', price: '42,000원',
    ...
    tags: ['CGM', '딥모이스처', '코일용'],
    imageUrl: 'assets/p_cream_devacurl.jpg'),
  Product(id: 11, category: 'curlcream', name: '뷰나 컬링 젤리 크림', brand: '뷰나', price: '15,500원',
    ...
    tags: ['젤리타입', '수분', '컬정의'],
    imageUrl: 'assets/p_cream_vuna.jpg'),
];
...
List<CommunityPost> communityPosts = [
  CommunityPost(id: 1, author: '꼬불이', avatar: '🌸', curlType: '3B', time: '2시간 전',
    ...
    imageUrl: 'assets/c_loc_success.jpg'),
  ...
  CommunityPost(id: 3, author: '컬리걸서울', avatar: '🍥', curlType: '3C', time: '어제',
    ...
    imageUrl: 'assets/c_devacurl_review.jpg'),
  ...
  CommunityPost(id: 5, author: '진지한웨이비', avatar: '🌊', curlType: '2B', time: '2일 전',
    ...
    imageUrl: 'assets/c_cgm_journey.jpg'),
];
...
List<DiaryEntry> diaryEntries = [
  DiaryEntry(id: 1, date: DateTime(2024, 3, 1),
    ...
    imageUrl: 'assets/d_good_day.jpg'),
  ...
  DiaryEntry(id: 3, date: DateTime(2024, 2, 22),
    ...
    imageUrl: 'assets/d_deep_care.jpg'),
];
