...
final _questions = [
  _Q('단계 1 · 시각적 분류', '샴푸 후 제품 없이 자연 건조했을 때,\n내 머리카락은 어떤 모습인가요?', [
    ...
    _Opt('2B','2B 중간 웨이브','🌊', sub:'뚜렷한 S자 웨이브'),
    _Opt('2C','2C 굵은 웨이브','🌀', sub:'굵은 S자, 습도에 민감'),
    _Opt('3A','3A 느슨한 컬','🫧', sub:'큰 링글렛 컬'),
    _Opt('3B','3B 탄탄한 컬','🍥', sub:'중간 나선형 컬'),
    _Opt('3C','3C 타이트 컬','🌿', sub:'코르크스크류 나선형'),
    _Opt('4A','4A 촘촘한 코일','🌸', sub:'촘촘한 S자 코일'),
    _Opt('4B','4B Z패턴 코일','⚡', sub:'Z자 꺾임 타이트 코일'),
    _Opt('4C','4C 극도의 코일','✨', sub:'패턴 없는 촘촘한 코일'),
  ]),
